...
**Emergency shutdown protocol for AI agents — halt all operations instantly when safety thresholds are breached.**

KILLSWITCH.md is a plain-text Markdown file you place in the root of any AI agent project. It defines automated shutdown triggers (cost limits, token rates, error thresholds), forbidden actions and resources, escalation protocols before full halt, audit logging, and human override requirements — so your agent stops itself before causing harm.

- Full specification: [killswitch.md](https://killswitch.md)
- AI-readable: [llms.txt](https://killswitch.md/llms.txt)
- License: MIT
...
Copy [`KILLSWITCH.md`](./KILLSWITCH.md) into your project root:
...
KILLSWITCH.md is part of a twelve-file open standard for AI agent safety, quality, and accountability:
